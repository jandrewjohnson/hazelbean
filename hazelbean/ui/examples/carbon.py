...
import hazelbean.invest.carbon
...
class Carbon(model.InVESTModel):
    def __init__(self):
        model.InVESTModel.__init__(self,
                             ...
                             target=hazelbean.invest.carbon.execute,
                             validator=hazelbean.invest.carbon.validate,
                             localdoc='../documentation/carbonstorage.html')
...
if __name__ == '__main__':
    # Creates the window based on the class definition above, adjusts the
    # window's geometry, sets the window filename and shows the window.
    carbon = Carbon()
    carbon.run()
